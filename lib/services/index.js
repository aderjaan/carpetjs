...
module.exports.prototype = {
  ...
  findOneAndRemove: function findOneAndRemove(req, params, fn) {
    if (typeof params === 'function') {
      fn = params;
      params = {};
      return this.findOneAndRemove(req, params, fn);
    }
    return this._find(req, params, fn, true, true);
  },
  ...
  findByIdAndRemove: function findByIdAndRemove(req, id, fn) {
    return this._find(req, {
      conditions: { _id: id }
    }, fn, true, true);
  },
  ...
  _find: function _find(req, params, fn, single, remove) {
    ...
    if (typeof params === 'function') {
      ...
      single = fn;
      remove = false;
      return this.find(req, params, fn, single, remove);
    }
    ...
    if (single && remove) {
      return this._model.findOneAndRemove(params.conditions, params, fn);
    }
