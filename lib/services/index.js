...
module.exports.prototype = {
  ...
  update: function update(req, conditions, changes, fn) {
    ...
    this._model.update(req, conditions, {
  ...
  remove: function remove(req, conditions, fn) {
    ...
    if (!!this._model.schema.paths.inactive) {
      ...
      return this._model.update(req, conditions, { inactive: true }, { multi: true }, fn);
    }
    this._model.remove(req, conditions, fn);
  },

  count: function count(req, conditions, callback) {
    this._model.count(req, conditions, callback);
  },

  distinct: function distinct(req, field, conditions, callback) {
    this._model.distinct(req, field, conditions, callback);
  },

  aggregate: function aggregate(req, cond, callback) {
    this._model.aggregate(req, cond, callback);
  },
  ...
  _find: function _find(req, params, fn, single) {
    ...
    this._model[func](req, params.conditions, params.fields, params, function (err, data) {
      if (err || !data) {
        return fn && fn(err);
      }
