...
module.exports.prototype = {
  ...
  getByIdParam: function (req, uri, id, fn) {
    if (this.loaders) {
      if (this.loaders[uri]) {
        return this.loaders[uri].call(this, req, id, fn);
      }
  ...
  _create: function (req, res) {
    ...
    this._mapper(req, req.body, function (data) {
      return self._service.create(req, data, function (err, model) {
        ...
        return self.getByIdParam(req, req.uri, $.utils.getId(model), $.utils.api.wrap(res, self));
      });
    }, true, true);
  },
