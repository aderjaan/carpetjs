...
module.exports.prototype = {
  ...
  getByIdParam: function (req, res, id, fn) {
  ...
  history: function (req, res) {
    ...
    $.service('history', 'shared').find(req, utils.api.params(req, {
      conditions: {
        'entity.$id': utils.getId(req.model)
      },
      sort_by: 'date',
      sort_type: -1
    }), utils.api.wrap(res, function (data) {
      require('../mongoose/history').parse(req, data, appName, req.model, function (data) {
