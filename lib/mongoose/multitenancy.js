...
module.exports = function (mongoose) {
  ...
  mongoose.Model.count = function(req, conditions) {
    conditions.organization = req.organizationId;
  ...
  mongoose.Model.distinct = function(req, field, conditions, fn) {
  ...
  mongoose.Model.aggregate = function(req, ops, fn) {
    ...
    ops[0].$match.organization = mongoose.Types.ObjectId(req.organizationId);
  ...
  mongoose.Model.prototype.insert = function(req, docs) {
    docs = docs.map(function (doc) {
      doc.organization = req.organizationId;
